...
The aim is to handle multiple live, concurrent connections on a single machine with minimum latency in each connection. It is done by using thread pooling and [EPOLL](https://en.wikipedia.org/wiki/Epoll)
